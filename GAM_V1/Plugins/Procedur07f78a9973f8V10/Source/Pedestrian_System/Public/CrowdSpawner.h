...
public:
	...
	void CrowdSpawnByDistance(float DistanceToSpawn, int32 MaxSpawnAmount, FVector CharacterHeight, FVector ProceduralSeparation, TSubclassOf<AActor> NPCToSpawn, FRotator SpawnRotation);
